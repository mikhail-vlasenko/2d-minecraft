# https://github.com/facebookresearch/jepa/blob/main/src%2Fmodels%2Fattentive_pooler.py
...
from reinforcement_learning.model.attention import CrossAttentionBlock, CrossAttention, Block
